...
import appprofiler.appprofilerv1.ItemListAdapters.ProcessListAdapter;
import appprofiler.appprofilerv1.ItemListAdapters.TasksListAdapter;
...
public class AndroidTaskManager extends Activity {
    ...
    protected static final String ACTION_LOAD_FINISH = "appprofiler.appprofilerv1.Androidtaskmanager.ACTION_LOAD_FINISH";

    private int mCurrentStat = STAT_TASK;
    private ItemListAdapters.ProcessListAdapter mAdapter;
	...
	private void getRunningProcess() {
        ...
        mAdapter = new ItemListAdapters.ProcessListAdapter(this, mListdp);
    }

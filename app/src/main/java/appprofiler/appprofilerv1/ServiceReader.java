...
//				.setTicker(getString(R.string.notify_read))
				.setSmallIcon(R.drawable.app_profiler)
				.setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.app_profiler, null))
		...
		mNotificationRecord = new Notification.Builder(this)
		        ...
		        .addAction(R.drawable.icon_stop, getString(R.string.menu_stop_record), pIStopRecord)
				.build();
...
//				Log.d("NativeHeapAllocatedSize", String.valueOf(Debug.getNativeHeapAllocatedSize()/1024));
	...
	private void record() {
		if (mW == null) {
			...
			File dir = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/App Profiler");
			dir.mkdirs();
